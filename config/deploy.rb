...
role :web, 'eopas-staging.intersect.org.au'
role :app, 'eopas-staging.intersect.org.au'
role :db,  'eopas-staging.intersect.org.au', :primary => true # This is where Rails migrations will run
